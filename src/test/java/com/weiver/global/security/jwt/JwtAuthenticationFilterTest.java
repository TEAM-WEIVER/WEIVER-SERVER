...
public class JwtAuthenticationFilterTest {
    ...
    private final JwtAuthenticationFilter jwtAuthenticationFilter = new JwtAuthenticationFilter(jwtTokenProvider, blacklistTokenRepository, bearerTokenResolver, securityErrorResponseWriter);
